...
cout << "++++++++++++ Based on Results_Sept02 ++++++++++++++ " << endl;
...
//sprintf(tempname,"../Results_Sept02/results_PhaseI_Stop_CharmLSP_14TEV_50PileUp_00.root");
//sprintf(tempname,"../Results_Sept02/results_PhaseI_Stop_CharmLSPv2_14TEV_50PileUp_00.root");
//sprintf(tempname,"../Results_Sept02/results_PhaseI_Stop_CharmLSPv3_14TEV_50PileUp_00.root");
//sprintf(tempname,"../Results_Sept02/results_PhaseI_t2cc450410_14TEV_50PileUp_00.root");  
//sprintf(tempname,"../Results_Sept02/results_PhaseI_t2cc450440_14TEV_50PileUp_00.root");
//sprintf(tempname,"../Results_Sept02/results_PhaseI_t2cc400390_14TEV_50PileUp_00.root");
//sprintf(tempname,"../Results_Sept02/results_PhaseI_t2cc400360_14TEV_50PileUp_00.root");
//sprintf(tempname,"../Results_Sept02/results_PhaseI_t2cc350340_14TEV_50PileUp_00.root");
//sprintf(tempname,"../Results_Sept02/results_PhaseI_t2cc350310_14TEV_50PileUp_00.root");
sprintf(tempname,"../Results_Sept02/results_PhaseI_Stop_CharmLSPv4_14TEV_50PileUp.root");
//sprintf(tempname,"../Results_Sept02/results_PhaseI_FullExceptStopv4_14TEV_50PileUp.root");
...
//sprintf(tempname,"PhaseI_Stop_CharmLSP_14TEV_50PileUp_00.root");
//sprintf(tempname,"PhaseI_Stop_CharmLSPv2_14TEV_50PileUp_00.root");
//sprintf(tempname,"PhaseI_Stop_CharmLSPv3_14TEV_50PileUp_00.root");
//sprintf(tempname,"PhaseI_t2cc450410_14TEV_50PileUp_00.root");  
//sprintf(tempname,"PhaseI_t2cc450440_14TEV_50PileUp_00.root");
//sprintf(tempname,"PhaseI_t2cc400390_14TEV_50PileUp_00.root");
//sprintf(tempname,"PhaseI_t2cc400360_14TEV_50PileUp_00.root");
//sprintf(tempname,"PhaseI_t2cc350340_14TEV_50PileUp_00.root");
//sprintf(tempname,"PhaseI_t2cc350310_14TEV_50PileUp_00.root");
sprintf(tempname,"PhaseI_Stop_CharmLSPv4_14TEV_50PileUp.root");
//sprintf(tempname,"PhaseI_FullExceptStopv4_14TEV_50PileUp.root");
...
//BJ Section//BJ Section//BJ Section//BJ Section//BJ Section//BJ Section//BJ Section//BJ Section//BJ Section//BJ Section//BJ Section
 ...
 //build a vector of scale factors
  ...
  for(int i=1; i<=bjnHT ; i++){
    sprintf(tempname,"../Results_Sept02/results_PhaseI_BJ_14TEV_HT%d_50PileUp.root",i);
    file = new TFile(tempname, "R");
    sprintf(tempname,"allEvents/nocut/MET_nocut_allEvents");
...
sprintf(tempname,"PhaseI_BJ_14TEV_50PileUp.root");
...
//TTbar Section//TTbar Section//TTbar Section//TTbar Section//TTbar Section//TTbar Section//TTbar Section//TTbar Section
  ...
  for(int i=1; i<=ttnHT ; i++){
    sprintf(tempname,"../Results_Sept02/results_PhaseI_TT_14TEV_HT%d_50PileUp.root",i);
    file = new TFile(tempname, "R");
    sprintf(tempname,"allEvents/nocut/MET_nocut_allEvents");
...
if(stackingswitch==true)tempstack = new THStack("stack","Binned Sample Stack");
sprintf(tempname,"PhaseI_TT_14TEV_50PileUp.root");
if(stackingswitch==true)file = new TFile(tempname,"RECREATE");
...
//B Section//B Section//B Section//B Section//B Section//B Section//B Section//B Section//B Section//B Section//B Section
 ...
 //build a vector of scale factors
  ...
  for(int i=1; i<=bnHT ; i++){
    sprintf(tempname,"../Results_Sept02/results_PhaseI_B_14TEV_HT%d_50PileUp.root",i);
    file = new TFile(tempname, "R");
    sprintf(tempname,"allEvents/nocut/MET_nocut_allEvents");
...
if(stackingswitch==true)tempstack = new THStack("stack","Binned Sample Stack");
sprintf(tempname,"PhaseI_B_14TEV_50PileUp.root");
if(stackingswitch==true)file = new TFile(tempname,"RECREATE");
...
//BJJ Section//BJJ Section//BJJ Section//BJJ Section//BJJ Section//BJJ Section//BJJ Section//BJJ Section//BJJ Section//BJJ Section//BJJ Section
 ...
 //build a vector of scale factors
  ...
  for(int i=1; i<=bjjnHT ; i++){
    sprintf(tempname,"../Results_Sept02/results_PhaseI_BJJ_14TEV_HT%d_50PileUp.root",i);
    file = new TFile(tempname, "R");
    sprintf(tempname,"allEvents/nocut/MET_nocut_allEvents");
...
if(stackingswitch==true)tempstack = new THStack("stack","Binned Sample Stack");
sprintf(tempname,"PhaseI_BJJ_14TEV_50PileUp.root");
if(stackingswitch==true)file = new TFile(tempname,"RECREATE");
 for(map<int , string >::iterator itt=OtherBGtype.begin(); itt!=OtherBGtype.end();itt++){        // loop over different event types
if(stackingswitch==true)cdtoitt = file->mkdir((itt->second).c_str());
if(stackingswitch==true)cdtoitt->cd();
...
//BB Section//BB Section//BB Section//BB Section//BB Section//BB Section//BB Section//BB Section//BB Section//BB Section//BB Section
 ...
 //build a vector of scale factors
  ...
  for(int i=1; i<=bbnHT ; i++){
    sprintf(tempname,"../Results_Sept02/results_PhaseI_BB_14TEV_HT%d_50PileUp.root",i);
    file = new TFile(tempname, "R");
    sprintf(tempname,"allEvents/nocut/MET_nocut_allEvents");
...
if(stackingswitch==true)tempstack = new THStack("stack","Binned Sample Stack");
sprintf(tempname,"PhaseI_BB_14TEV_50PileUp.root");
if(stackingswitch==true)file = new TFile(tempname,"RECREATE");
 for(map<int , string >::iterator itt=OtherBGtype.begin(); itt!=OtherBGtype.end();itt++){        // loop over different event types
if(stackingswitch==true)cdtoitt = file->mkdir((itt->second).c_str());
if(stackingswitch==true)cdtoitt->cd();
...
//BBB Section//BBB Section//BBB Section//BBB Section//BBB Section//BBB Section//BBB Section//BBB Section//BBB Section//BBB Section//BBB Section
 ...
 //build a vector of scale factors
  ...
  for(int i=1; i<=bbbnHT ; i++){
    sprintf(tempname,"../Results_Sept02/results_PhaseI_BBB_14TEV_HT%d_50PileUp.root",i);
    file = new TFile(tempname, "R");
    sprintf(tempname,"allEvents/nocut/MET_nocut_allEvents");
...
if(stackingswitch==true)tempstack = new THStack("stack","Binned Sample Stack");
sprintf(tempname,"PhaseI_BBB_14TEV_50PileUp.root");
if(stackingswitch==true)file = new TFile(tempname,"RECREATE");
 for(map<int , string >::iterator itt=OtherBGtype.begin(); itt!=OtherBGtype.end();itt++){        // loop over different event types
if(stackingswitch==true)cdtoitt = file->mkdir((itt->second).c_str());
if(stackingswitch==true)cdtoitt->cd();
...
//H Section//H Section//H Section//H Section//H Section//H Section//H Section//H Section//H Section//H Section//H Section
 ...
 //build a vector of scale factors
  ...
  for(int i=1; i<=hnHT ; i++){
    sprintf(tempname,"../Results_Sept02/results_PhaseI_H_14TEV_HT%d_50PileUp.root",i);
    file = new TFile(tempname, "R");
    sprintf(tempname,"allEvents/nocut/MET_nocut_allEvents");
...
if(stackingswitch==true)tempstack = new THStack("stack","Binned Sample Stack");
sprintf(tempname,"PhaseI_H_14TEV_50PileUp.root");
if(stackingswitch==true)file = new TFile(tempname,"RECREATE");
 for(map<int , string >::iterator itt=OtherBGtype.begin(); itt!=OtherBGtype.end();itt++){        // loop over different event types
if(stackingswitch==true)cdtoitt = file->mkdir((itt->second).c_str());
if(stackingswitch==true)cdtoitt->cd();
...
//LL Section//LL Section//LL Section//LL Section//LL Section//LL Section//LL Section//LL Section//LL Section//LL Section//LL Section
 ...
 //build a vector of scale factors
  ...
  for(int i=1; i<=llnHT ; i++){
    sprintf(tempname,"../Results_Sept02/results_PhaseI_LL_14TEV_HT%d_50PileUp.root",i);
    file = new TFile(tempname, "R");
    sprintf(tempname,"allEvents/nocut/MET_nocut_allEvents");
...
if(stackingswitch==true)tempstack = new THStack("stack","Binned Sample Stack");
sprintf(tempname,"PhaseI_LL_14TEV_50PileUp.root");
if(stackingswitch==true)file = new TFile(tempname,"RECREATE");
 for(map<int , string >::iterator itt=OtherBGtype.begin(); itt!=OtherBGtype.end();itt++){        // loop over different event types
if(stackingswitch==true)cdtoitt = file->mkdir((itt->second).c_str());
if(stackingswitch==true)cdtoitt->cd();
...
//LLB Section//LLB Section//LLB Section//LLB Section//LLB Section//LLB Section//LLB Section//LLB Section//LLB Section//LLB Section//LLB Section
 ...
 //build a vector of scale factors
  ...
  for(int i=1; i<=llbnHT ; i++){
    sprintf(tempname,"../Results_Sept02/results_PhaseI_LLB_14TEV_HT%d_50PileUp.root",i);
    file = new TFile(tempname, "R");
    sprintf(tempname,"allEvents/nocut/MET_nocut_allEvents");
...
if(stackingswitch==true)tempstack = new THStack("stack","Binned Sample Stack");
sprintf(tempname,"PhaseI_LLB_14TEV_50PileUp.root");
if(stackingswitch==true)file = new TFile(tempname,"RECREATE");
 for(map<int , string >::iterator itt=OtherBGtype.begin(); itt!=OtherBGtype.end();itt++){        // loop over different event types
if(stackingswitch==true)cdtoitt = file->mkdir((itt->second).c_str());
if(stackingswitch==true)cdtoitt->cd();
...
//TB Section//TB Section//TB Section//TB Section//TB Section//TB Section//TB Section//TB Section//TB Section//TB Section//TB Section
 ...
 //build a vector of scale factors
  ...
  for(int i=1; i<=tbnHT ; i++){
    sprintf(tempname,"../Results_Sept02/results_PhaseI_TB_14TEV_HT%d_50PileUp.root",i);
    file = new TFile(tempname, "R");
    sprintf(tempname,"allEvents/nocut/MET_nocut_allEvents");
...
if(stackingswitch==true)tempstack = new THStack("stack","Binned Sample Stack");
sprintf(tempname,"PhaseI_TB_14TEV_50PileUp.root");
if(stackingswitch==true)file = new TFile(tempname,"RECREATE");
 for(map<int , string >::iterator itt=OtherBGtype.begin(); itt!=OtherBGtype.end();itt++){        // loop over different event types
if(stackingswitch==true)cdtoitt = file->mkdir((itt->second).c_str());
if(stackingswitch==true)cdtoitt->cd();
...
//TJ Section//TJ Section//TJ Section//TJ Section//TJ Section//TJ Section//TJ Section//TJ Section//TJ Section//TJ Section//TJ Section
 ...
 //build a vector of scale factors
  ...
  for(int i=1; i<=tjnHT ; i++){
    sprintf(tempname,"../Results_Sept02/results_PhaseI_TJ_14TEV_HT%d_50PileUp.root",i);
    file = new TFile(tempname, "R");
    sprintf(tempname,"allEvents/nocut/MET_nocut_allEvents");
...
if(stackingswitch==true)tempstack = new THStack("stack","Binned Sample Stack");
sprintf(tempname,"PhaseI_TJ_14TEV_50PileUp.root");
if(stackingswitch==true)file = new TFile(tempname,"RECREATE");
 for(map<int , string >::iterator itt=OtherBGtype.begin(); itt!=OtherBGtype.end();itt++){        // loop over different event types
if(stackingswitch==true)cdtoitt = file->mkdir((itt->second).c_str());
if(stackingswitch==true)cdtoitt->cd();
...
//  TTB_xs_vec.push_back();
  ...
  for(int i=1; i<=ttbnHT ; i++){
    sprintf(tempname,"../Results_Sept02/results_PhaseI_TTB_14TEV_HT%d_50PileUp.root",i);
    file = new TFile(tempname, "R");
    sprintf(tempname,"allEvents/nocut/MET_nocut_allEvents");
...
if(stackingswitch==true)tempstack = new THStack("stack","Binned Sample Stack");
sprintf(tempname,"PhaseI_TTB_14TEV_50PileUp.root");
if(stackingswitch==true)file = new TFile(tempname,"RECREATE");
 for(map<int , string >::iterator itt=OtherBGtype.begin(); itt!=OtherBGtype.end();itt++){        // loop over different event types
if(stackingswitch==true)cdtoitt = file->mkdir((itt->second).c_str());
if(stackingswitch==true)cdtoitt->cd();
...
totalBG=(double) (yieldmap[i].at(2)+yieldmap[i].at(3)+yieldmap[i].at(4));
delWlv= 0.08*yieldmap[i].at(2);///uncrtainty for Wlv is 8%
delZvv= 0.05*yieldmap[i].at(3);
delTT= 0.5*yieldmap[i].at(4);///uncrtainty for TTbar is 50%
delBsquare=pow(delWlv,2)+pow(delZvv,2)+pow(delTT,2);///delta_background = sqrt(delWlv^2+delZvv^2+delTT^2)
ff << " " <<cutname[i]<<", " << yieldmap[i].at(0) << ", " << yieldmap[i].at(2) <<", " << yieldmap[i].at(3) <<", " <<yieldmap[i].at(4) << ", "<< totalBG << ", " << yieldmap[i].at(0)/totalBG*100 << ", " << yieldmap[i].at(0)/sqrt(delBsquare+totalBG+yieldmap[i].at(0)) <<endl;
}
ff.close();
